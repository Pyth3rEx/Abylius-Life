...
/* System Settings */
    ...
    gang_price = 600000; //Gang creation price. --Remember they are persistent so keep it reasonable to avoid millions of gangs.
    ...
    house_limit = 50; //Maximum number of houses a player can own.
    ...
    crimes[] = {
        ...
        {"STR_Crime_213","250000","213"},
        {"STR_Crime_211","5000","211"},
        {"STR_Crime_207","25000","207"},
        {"STR_Crime_207A","12500","207A"},
        {"STR_Crime_390","250000","390"},
        ...
        {"STR_Crime_23","2000000","23"},
        {"STR_Crime_24","100000","24"},
        {"STR_Crime_25","1000000","25"}
    };
};
